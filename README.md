...
### 2.1 Clone Livox ROS Driver 2 source code into your ROS2 workspace

```shell
cd ~/ros2_ws/src
git clone --branch ROS2 https://github.com/Livox-SDK/livox_ros_driver2.git ws_livox/src/livox_ros_driver2
```
